...
import type { HighlightColor, HighlightRow } from "../readerTypes";
...
function HighlightOverlayImpl({ width, height, highlights, disabled, activeHighlightId, onPressHighlight }: Props) {
...
export default React.memo(HighlightOverlayImpl);
